...
#define MyAppExeName "CXML_GTK_V1.6.exe"
...
OutputDir=D:\Projets\CXML\working_builds\part_4\windows\v1.6
OutputBaseFilename=CXML_setup_{#MyAppVersion}
SetupIconFile=D:\Projets\CXML\working_builds\part_4\windows\v1.6\gtk_files\CXML.ico
Compression=lzma
...
[Files]
Source: "D:\Projets\CXML\working_builds\part_4\windows\v1.6\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Projets\CXML\working_builds\part_4\windows\v1.6\gtk_files\*"; DestDir: "{app}\gtk_files"; Flags: ignoreversion recursesubdirs createallsubdirs
